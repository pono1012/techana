        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.radar, color: Theme.of(context).colorScheme.primary, size: 28),
                  const SizedBox(width: 12),
                  Text("LIVE SCANNER", style: TextStyle(fontFamily: 'Outfit', fontWeight: FontWeight.w900, fontSize: 18, color: Theme.of(context).colorScheme.primary, letterSpacing: 2)),
                ],
              ),
              if (exec.isScanning)
                Container(
                  ...
                  child: Row(
                    children: [
                      const SizedBox(width: 8, height: 8, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.greenAccent)),
                      const SizedBox(width: 8),
                      Text("ACTIVE", style: TextStyle(color: Colors.greenAccent, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1)),
                    ],
                  ),
                )
            ],
          ...
          if (exec.isScanning) ...[
            Text("ANALYZING", style: TextStyle(color: Colors.white30, fontSize: 10, letterSpacing: 2)),
            const SizedBox(height: 4),
            Text(
              exec.currentlyScanningSymbol.isEmpty ? "..." : exec.currentlyScanningSymbol,
              style: TextStyle(fontFamily: 'Outfit', fontSize: 32, fontWeight: FontWeight.w300, color: Colors.white, letterSpacing: 4),
            ),
            const SizedBox(height: 8),
            LinearProgressIndicator(
              value: exec.scanTotal > 0 ? exec.scanCurrent / exec.scanTotal : 0,
          ...
          if (topRecs.isNotEmpty) ...[
            Text("TOP TARGETS", style: TextStyle(color: Colors.white30, fontSize: 10, letterSpacing: 2)),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        Text(symbol, style: const TextStyle(fontFamily: 'Outfit', fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 1)),
                      ],
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text("BUY: ${signal.entryPrice.toStringAsFixed(2)}", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white)),
                        Text("TP: ${signal.takeProfit1.toStringAsFixed(2)}", style: const TextStyle(fontSize: 10, color: Colors.white54)),
                      ],
                    ),
                  ],
                ),
